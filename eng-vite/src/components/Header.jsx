...
{isOpen ? (
  ...
  <Link to="/welcome" className="block font-bold mt-4 md:inline-block md:mt-0 text-black hover:scale-110 transform transition-transform duration-200mr-6">Welcome</Link>
  <Link to="/chatbot" className="block font-bold mt-4 md:inline-block md:mt-0 text-black hover:scale-110 transform transition-transform duration-200mr-6">Chatbot</Link>
  <Link to="/politeenglish" className="block font-bold mt-4 md:inline-block md:mt-0 text-black hover:scale-110 transform transition-transform duration-200 mr-6">Polite English</Link>
  <Link to="/form" className="block font-bold mt-4 md:inline-block md:mt-0 text-black hover:scale-110 transform transition-transform duration-200 mr-6">Contact</Link>
</div>
