...
function ContactForm() {
  ...
  return (
      ...
      <ValidationError 
        ...
        className="text-red-500 text-xs italic"
      />
      <button type="submit" disabled={state.submitting} className="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline mt-5">
        Submit
      </button>
    </form>
  );
